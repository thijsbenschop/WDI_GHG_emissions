...
```{r display_cur_indicators, include = TRUE}
...
```{r list_of_new_indicators, include = FALSE}
kable(new_indicators)
```

### Scores of new indicators
All 26 indicators have the same score of 3.571429 when using the extrapolated datasets.
