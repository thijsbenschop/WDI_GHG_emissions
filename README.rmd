...
new_indicators <- read_xlsx("./Data/proposal_ghg_restructuring.xlsx")
```
...
```{r display_scoring_cur_indicators, include = TRUE}
...
```{r list_of_new_indicators, include = TRUE}
...
```{r score_of_new_indicators, include = FALSE}
...
### Units
Convert all GHG data into CO2e for comparison or report in tons of respective GHG
...
Proposal: Include extrapolated values for copmpleteness and update series regularly.
